...
From within the root directory do `npm install -g openapi-cop-proxy`, or `npm install openapi-cop-proxy` to install locally.

You can of course also install the package provided in the release with `npm install ./proxy/openapi-cop-proxy.tgz`.
